...
<div>
  ...
  <main>
    <section class="bg-blue-700 dark:bg-blue-600 ">
        <div class="grid max-w-screen-xl px-4 py-10 mx-auto ">
            <div class="lg:py-28 md:py-28 py-16">
                <h1 class=" mb-10 text-5xl font-bold tracking-tight leading-none md:text-6xl xl:text-8xl text-white">Garis Kode Digital Creative Agency</h1>
                <p class="max-w-4xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl text-white">We provide high-quality websites at affordable prices, along with continuous application development services tailored to meet your needs.</p>
              </div>             
        </div>
    </section>
    <section class="bg-white dark:bg-gray-900">
      <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-24 lg:px-12">
        <a href="#" class="inline-flex justify-between items-center py-1 px-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
            <span class="text-sm font-medium">See Our Products</span> 
            <svg class="ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
        </a>
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">What We Do?</h1>
        <p class="mb-24 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">We provide high-quality websites at affordable prices, along with continuous application development services tailored to meet your needs.</p>
        <div class="space-y-8 md:grid md:grid-cols-3 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Grapich Design</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Internet Of Things</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">App Development</h3>
    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-24 lg:px-6">
        <div class="text-gray-500 sm:text-lg dark:text-gray-400">
          ...
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Let's create more tools and ideas that brings us together.</h2>
            <p class="mb-6 text-gray-500 dark:text-gray-400">Flowbite helps you connect with friends and communities of people who share your interests. Connecting with your friends and family as well as discovering new ones is easy with features like Groups.</p>
    ...
    <section class="bg-blue-700 dark:bg-blue-600">
      <div class="py-24 px-4 mx-auto max-w-screen-xl lg:px-6">
          <div class="mx-auto mb-8 flex justify-between items-center">
              <h2 class="text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 text-white">Our Blog</h2>
              <span class="text-white">see more</span>
          </div> 
          <div class="grid gap-8 lg:grid-cols-3">
            <article class="bg-white rounded-lg shadow-md dark:bg-gray-800">
                <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/content/office-long-2.png" alt="Our first office" class="w-full h-40 object-cover">
                <div class="p-6">
              ...
              <article class="bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div class="p-6">
                  <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="#">Our first project with React</a></h2>
                  <p class="mb-5 text-gray-500 dark:text-gray-400">Static websites are now used to bootstrap lots of websites and are becoming the basis for a variety of tools that even influence both web designers and developers influence both web designers and developers.</p>
                  <div class="flex justify-between items-center">
                      <div class="flex items-center space-x-4">
                          <img class="w-7 h-7 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" alt="Bonnie Green avatar" />
                          <span class="font-medium dark:text-white">
