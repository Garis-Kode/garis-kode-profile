...
<div>
  <header>
    <nav class="bg-blue-700 dark:bg-blue-600 border-gray-200 px-4 lg:px-6 py-8">
        <div class="flex flex-wrap lg:justify-center justify-between items-center mx-auto max-w-screen-xl">
            <a href="https://flowbite.com" class="flex items-center lg:hidden">
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-2" id="mobile-menu-2">
                <ul class="flex flex-col mt-5 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <a href="https://flowbite.com" class="flex items-center hidden lg:block">
                      <img src="https://flowbite.com/docs/images/logo.svg" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
                    </a>
                    <li>
    ...
    <section class="bg-blue-700 dark:bg-blue-600 ">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto ">
            <div class="lg:py-28 md:py-28">
                ...
                <p class="max-w-4xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl text-white">Custom-tailored software solutions designed to elevate your business, streamline operations, and drive innovation in an ever-evolving digital landscape.</p>
              </div>             
        </div>
    </section>
